                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="longitude"
                                        autocomplete="off" value="{{ old('longitude', $kecelakaan->lokasi->longitude) }}"
                                        readonly id="longitude">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" autocomplete="off"
                                        name="latitude" value="{{ old('latitude', $kecelakaan->lokasi->latitude) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="tingkat_kecelakaan"
                                ...
                                <option value="ringan"
                                    {{ old('tingkat_kecelakaan', $kecelakaan->tingkat_kecelakaan) == 'ringan' ? 'selected' : '' }}>
                                    Ringan
                                </option>
                                <option value="sedang"
                                    {{ old('tingkat_kecelakaan', $kecelakaan->tingkat_kecelakaan) == 'sedang' ? 'selected' : '' }}>
                                    Sedang
                                </option>
                                <option value="berat"
                                    {{ old('tingkat_kecelakaan', $kecelakaan->tingkat_kecelakaan) == 'berat' ? 'selected' : '' }}>
                                    Berat
                                </option>
                            </select>
...
@push('script')
    <script>
        ...
        // Geocoding
        $('#nama_jalan').on('keyup', function(e) {
